...
int main() {
    ...
    else if (originNumberBase == 16) {

        // I AM GOING TO USE BASE 10 AS AN INTERMEDIATE REPRESENTATION (OR FINAL REPRESENTATION IF 'destinationNumberBase' == 10)
    ...
    if (destinationNumberBase != 10) {
        ...
        if (numberToConvert.at(0) == '-') {
            ...
            if (destinationNumberBase == 2) {
                ...
                result = '-' + decimalToHexadecimal(abs(number));
